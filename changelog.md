...
### [0.1.60] â€” 2026-08-08
- **Lettura VBUS via Modulo Assistito**: Quando l'ADC locale della Base Ã¨ disabilitato (GPIO 34 non Ã¨ un canale ADC su ESP32-S3), la Base interroga via I2C lo Speaker/modulo collegato (`CMD_GET_VBUS_VOLTAGE`) per mostrare il VBUS reale nei log e sul cruscotto dell'App.
...
- UART output is preserved in parallel â€” no functionality change if no client is connected.
